...
def parse_args():
    ...
    parser.add_argument("-d", "--topdir", dest="topdir", help="The batch_files directory")
    parser.add_argument("-m", "--model_name", dest="model_name", help="Model name")
    parser.add_argument("-o", "--outdir", dest="outdir", default='',
                        help="Output directory for the prediction on new batch_files")
...
if __name__ == "__main__":
    ...
    # 创建输出目录
    out_dir = "./saved_models/" + model_name
    ...
    # 加载模型
    baseModel = get_model(model_name)
    ...
    if args.hyper:
        # 搜索最优参数
        hb = Hyperband(baseModel, args.topdir, max_iter=args.hyperiter,
